...
<head>
<title>TPTP Problem File: SET033-6.p</title>
...
<body>
<HR><CENTER>
<H2>TPTP Problem File: SET033-6.p</H2><A HREF=SeeTPTP?Category=Solutions&Domain=SET&File=SET033-6 TARGET=_blank>
View Solutions</A>
- <A HREF="https://tptp.org/cgi-bin/SystemOnTPTP?TPTPProblem=SET033-6" TARGET="_blank">Solve Problem</A>
</CENTER><HR>
<pre>
%--------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
<A NAME="prove_boyer_lemma_18_1"></A>cnf(prove_boyer_lemma_18_1,negated_conjecture,
    subclass(range_of(xr),domain_of(yr)) ).

<A NAME="prove_boyer_lemma_18_2"></A>cnf(prove_boyer_lemma_18_2,negated_conjecture,
