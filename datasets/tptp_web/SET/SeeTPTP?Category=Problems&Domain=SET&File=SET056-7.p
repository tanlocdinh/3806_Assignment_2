...
<head>
<title>TPTP Problem File: SET056-7.p</title>
...
<body>
<HR><CENTER>
<H2>TPTP Problem File: SET056-7.p</H2><A HREF=SeeTPTP?Category=Solutions&Domain=SET&File=SET056-7 TARGET=_blank>
View Solutions</A>
- <A HREF="https://tptp.org/cgi-bin/SystemOnTPTP?TPTPProblem=SET056-7" TARGET="_blank">Solve Problem</A>
</CENTER><HR>
<pre>
%--------------------------------------------------------------------------
...
<A NAME="prove_equality1_1"></A>cnf(prove_equality1_1,negated_conjecture,
    x != y ).

<A NAME="prove_equality1_2"></A>cnf(prove_equality1_2,negated_conjecture,
    ~ member(not_subclass_element(x,y),x) ).

<A NAME="prove_equality1_3"></A>cnf(prove_equality1_3,negated_conjecture,
