...
<head>
<title>TPTP Problem File: SET030-3.p</title>
...
<body>
<HR><CENTER>
<H2>TPTP Problem File: SET030-3.p</H2><A HREF=SeeTPTP?Category=Solutions&Domain=SET&File=SET030-3 TARGET=_blank>
View Solutions</A>
- <A HREF="https://tptp.org/cgi-bin/SystemOnTPTP?TPTPProblem=SET030-3" TARGET="_blank">Solve Problem</A>
</CENTER><HR>
<pre>
%--------------------------------------------------------------------------
...
<A NAME="prove_function_values_are_small"></A>cnf(prove_function_values_are_small,negated_conjecture,
