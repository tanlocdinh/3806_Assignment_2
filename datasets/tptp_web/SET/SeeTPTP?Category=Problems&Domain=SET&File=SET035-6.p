...
<head>
<title>TPTP Problem File: SET035-6.p</title>
...
<body>
<HR><CENTER>
<H2>TPTP Problem File: SET035-6.p</H2><A HREF=SeeTPTP?Category=Solutions&Domain=SET&File=SET035-6 TARGET=_blank>
View Solutions</A>
- <A HREF="https://tptp.org/cgi-bin/SystemOnTPTP?TPTPProblem=SET035-6" TARGET="_blank">Solve Problem</A>
</CENTER><HR>
<pre>
%--------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
<A NAME="prove_composition_of_mappings_1"></A>cnf(prove_composition_of_mappings_1,negated_conjecture,
    maps(xf,u,v) ).

<A NAME="prove_composition_of_mappings_2"></A>cnf(prove_composition_of_mappings_2,negated_conjecture,
    maps(xg,v,w) ).

<A NAME="prove_composition_of_mappings_3"></A>cnf(prove_composition_of_mappings_3,negated_conjecture,
