...
<head>
<title>TPTP Problem File: SET003-1.p</title>
...
<body>
<HR><CENTER>
<H2>TPTP Problem File: SET003-1.p</H2><A HREF=SeeTPTP?Category=Solutions&Domain=SET&File=SET003-1 TARGET=_blank>
View Solutions</A>
- <A HREF="https://tptp.org/cgi-bin/SystemOnTPTP?TPTPProblem=SET003-1" TARGET="_blank">Solve Problem</A>
</CENTER><HR>
<pre>
%--------------------------------------------------------------------------
...
<A NAME="prove_a_is_a_subset_of_aUa"></A>cnf(prove_a_is_a_subset_of_aUa,negated_conjecture,
    ~ subset(a,aUa) ).
