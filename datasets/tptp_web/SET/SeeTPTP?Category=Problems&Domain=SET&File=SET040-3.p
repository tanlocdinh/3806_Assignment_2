...
<head>
<title>TPTP Problem File: SET040-3.p</title>
...
<body>
<HR><CENTER>
<H2>TPTP Problem File: SET040-3.p</H2><A HREF=SeeTPTP?Category=Solutions&Domain=SET&File=SET040-3 TARGET=_blank>
View Solutions</A>
- <A HREF="https://tptp.org/cgi-bin/SystemOnTPTP?TPTPProblem=SET040-3" TARGET="_blank">Solve Problem</A>
</CENTER><HR>
<pre>
%--------------------------------------------------------------------------
...
<A NAME="prove_apply_for_composition2"></A>cnf(prove_apply_for_composition2,negated_conjecture,
