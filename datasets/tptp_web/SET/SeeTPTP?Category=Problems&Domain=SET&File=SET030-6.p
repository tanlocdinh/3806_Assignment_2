...
<head>
<title>TPTP Problem File: SET030-6.p</title>
...
<body>
<HR><CENTER>
<H2>TPTP Problem File: SET030-6.p</H2><A HREF=SeeTPTP?Category=Solutions&Domain=SET&File=SET030-6 TARGET=_blank>
View Solutions</A>
- <A HREF="https://tptp.org/cgi-bin/SystemOnTPTP?TPTPProblem=SET030-6" TARGET="_blank">Solve Problem</A>
</CENTER><HR>
<pre>
%--------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
<A NAME="prove_application_property8_1"></A>cnf(prove_application_property8_1,negated_conjecture,
    single_valued_class(xf) ).

<A NAME="prove_application_property8_2"></A>cnf(prove_application_property8_2,negated_conjecture,
