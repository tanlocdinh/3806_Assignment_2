...
<head>
<title>TPTP Problem File: SET025-9.p</title>
...
<body>
<HR><CENTER>
<H2>TPTP Problem File: SET025-9.p</H2><A HREF=SeeTPTP?Category=Solutions&Domain=SET&File=SET025-9 TARGET=_blank>
View Solutions</A>
- <A HREF="https://tptp.org/cgi-bin/SystemOnTPTP?TPTPProblem=SET025-9" TARGET="_blank">Solve Problem</A>
</CENTER><HR>
<pre>
%--------------------------------------------------------------------------
...
<A NAME="prove_predicate_is_small"></A>cnf(prove_predicate_is_small,negated_conjecture,
    ~ little_set(a) ).
