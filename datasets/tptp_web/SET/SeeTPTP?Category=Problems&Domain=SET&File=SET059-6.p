...
<head>
<title>TPTP Problem File: SET059-6.p</title>
...
<body>
<HR><CENTER>
<H2>TPTP Problem File: SET059-6.p</H2><A HREF=SeeTPTP?Category=Solutions&Domain=SET&File=SET059-6 TARGET=_blank>
View Solutions</A>
- <A HREF="https://tptp.org/cgi-bin/SystemOnTPTP?TPTPProblem=SET059-6" TARGET="_blank">Solve Problem</A>
</CENTER><HR>
<pre>
%--------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
<A NAME="prove_equality4_1"></A>cnf(prove_equality4_1,negated_conjecture,
    member(not_subclass_element(x,y),y) ).

<A NAME="prove_equality4_2"></A>cnf(prove_equality4_2,negated_conjecture,
    member(not_subclass_element(y,x),x) ).

<A NAME="prove_equality4_3"></A>cnf(prove_equality4_3,negated_conjecture,
    x != y ).
