...
<head>
<title>TPTP Problem File: SET054-7.p</title>
...
<body>
<HR><CENTER>
<H2>TPTP Problem File: SET054-7.p</H2><A HREF=SeeTPTP?Category=Solutions&Domain=SET&File=SET054-7 TARGET=_blank>
View Solutions</A>
- <A HREF="https://tptp.org/cgi-bin/SystemOnTPTP?TPTPProblem=SET054-7" TARGET="_blank">Solve Problem</A>
</CENTER><HR>
<pre>
%--------------------------------------------------------------------------
...
<A NAME="prove_subclass_is_reflexive_1"></A>cnf(prove_subclass_is_reflexive_1,negated_conjecture,
    ~ subclass(x,x) ).
