...
<head>
<title>TPTP Problem File: SET062-7.p</title>
...
<body>
<HR><CENTER>
<H2>TPTP Problem File: SET062-7.p</H2><A HREF=SeeTPTP?Category=Solutions&Domain=SET&File=SET062-7 TARGET=_blank>
View Solutions</A>
- <A HREF="https://tptp.org/cgi-bin/SystemOnTPTP?TPTPProblem=SET062-7" TARGET="_blank">Solve Problem</A>
</CENTER><HR>
<pre>
%--------------------------------------------------------------------------
...
<A NAME="prove_null_class_is_subclass_1"></A>cnf(prove_null_class_is_subclass_1,negated_conjecture,
