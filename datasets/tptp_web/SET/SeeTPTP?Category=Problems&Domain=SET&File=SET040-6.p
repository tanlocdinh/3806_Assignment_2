...
<head>
<title>TPTP Problem File: SET040-6.p</title>
...
<body>
<HR><CENTER>
<H2>TPTP Problem File: SET040-6.p</H2><A HREF=SeeTPTP?Category=Solutions&Domain=SET&File=SET040-6 TARGET=_blank>
View Solutions</A>
- <A HREF="https://tptp.org/cgi-bin/SystemOnTPTP?TPTPProblem=SET040-6" TARGET="_blank">Solve Problem</A>
</CENTER><HR>
<pre>
%--------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
<A NAME="prove_application_property12_1"></A>cnf(prove_application_property12_1,negated_conjecture,
    function(xf) ).

<A NAME="prove_application_property12_2"></A>cnf(prove_application_property12_2,negated_conjecture,
