...
<head>
<title>TPTP Problem File: SET034-3.p</title>
...
<body>
<HR><CENTER>
<H2>TPTP Problem File: SET034-3.p</H2><A HREF=SeeTPTP?Category=Solutions&Domain=SET&File=SET034-3 TARGET=_blank>
View Solutions</A>
- <A HREF="https://tptp.org/cgi-bin/SystemOnTPTP?TPTPProblem=SET034-3" TARGET="_blank">Solve Problem</A>
</CENTER><HR>
<pre>
%--------------------------------------------------------------------------
...
<A NAME="another_function"></A>cnf(another_function,hypothesis,
