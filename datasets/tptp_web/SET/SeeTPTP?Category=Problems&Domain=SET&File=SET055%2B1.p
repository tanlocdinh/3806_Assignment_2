...
<head>
<title>TPTP Problem File: SET055+1.p</title>
...
<body>
<HR><CENTER>
<H2>TPTP Problem File: SET055+1.p</H2><A HREF=SeeTPTP?Category=Solutions&Domain=SET&File=SET055+1 TARGET=_blank>
View Solutions</A>
- <A HREF="https://tptp.org/cgi-bin/SystemOnTPTP?TPTPProblem=SET055%2B1" TARGET="_blank">Solve Problem</A>
</CENTER><HR>
<pre>
%--------------------------------------------------------------------------
...
<A NAME="reflexivity"></A>fof(reflexivity,conjecture,
    ! [X] : X = X ).
