...
<head>
<title>TPTP Problem File: SET027-4.p</title>
...
<body>
<HR><CENTER>
<H2>TPTP Problem File: SET027-4.p</H2><A HREF=SeeTPTP?Category=Solutions&Domain=SET&File=SET027-4 TARGET=_blank>
View Solutions</A>
- <A HREF="https://tptp.org/cgi-bin/SystemOnTPTP?TPTPProblem=SET027-4" TARGET="_blank">Solve Problem</A>
</CENTER><HR>
<pre>
%--------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
<A NAME="a_subset_b"></A>cnf(a_subset_b,hypothesis,
    subset(a,b) ).

<A NAME="b_subset_c"></A>cnf(b_subset_c,hypothesis,
    subset(b,c) ).

<A NAME="prove_a_subset_c"></A>cnf(prove_a_subset_c,negated_conjecture,
    ~ subset(a,c) ).
