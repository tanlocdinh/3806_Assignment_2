...
View Solutions</A>
- <A HREF="https://tptp.org/cgi-bin/SystemOnTPTP?TPTPProblem=SET018%2B1" TARGET="_blank">Solve Problem</A>
</CENTER><HR>
<pre>
%--------------------------------------------------------------------------
...
<A NAME="ordered_pair_determines_components2"></A>fof(ordered_pair_determines_components2,conjecture,
    ! [W,X,Y,Z] :
