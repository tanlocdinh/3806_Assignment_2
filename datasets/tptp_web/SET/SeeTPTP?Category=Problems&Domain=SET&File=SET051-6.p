...
<head>
<title>TPTP Problem File: SET051-6.p</title>
...
<body>
<HR><CENTER>
<H2>TPTP Problem File: SET051-6.p</H2><A HREF=SeeTPTP?Category=Solutions&Domain=SET&File=SET051-6 TARGET=_blank>
View Solutions</A>
- <A HREF="https://tptp.org/cgi-bin/SystemOnTPTP?TPTPProblem=SET051-6" TARGET="_blank">Solve Problem</A>
</CENTER><HR>
<pre>
%--------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
<A NAME="prove_corollary_2_to_unordered_pair_1"></A>cnf(prove_corollary_2_to_unordered_pair_1,negated_conjecture,
    member(ordered_pair(x,y),cross_product(u,v)) ).

<A NAME="prove_corollary_2_to_unordered_pair_2"></A>cnf(prove_corollary_2_to_unordered_pair_2,negated_conjecture,
