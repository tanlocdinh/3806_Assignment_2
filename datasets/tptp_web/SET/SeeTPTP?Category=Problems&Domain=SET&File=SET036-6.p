...
<head>
<title>TPTP Problem File: SET036-6.p</title>
...
<body>
<HR><CENTER>
<H2>TPTP Problem File: SET036-6.p</H2><A HREF=SeeTPTP?Category=Solutions&Domain=SET&File=SET036-6 TARGET=_blank>
View Solutions</A>
- <A HREF="https://tptp.org/cgi-bin/SystemOnTPTP?TPTPProblem=SET036-6" TARGET="_blank">Solve Problem</A>
</CENTER><HR>
<pre>
%--------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
<A NAME="prove_application_property9_1"></A>cnf(prove_application_property9_1,negated_conjecture,
    single_valued_class(xf) ).

<A NAME="prove_application_property9_2"></A>cnf(prove_application_property9_2,negated_conjecture,
    member(ordered_pair(x,y),xf) ).

<A NAME="prove_application_property9_3"></A>cnf(prove_application_property9_3,negated_conjecture,
    member(ordered_pair(x,y),cross_product(universal_class,universal_class)) ).

<A NAME="prove_application_property9_4"></A>cnf(prove_application_property9_4,negated_conjecture,
    apply(xf,x) != y ).
