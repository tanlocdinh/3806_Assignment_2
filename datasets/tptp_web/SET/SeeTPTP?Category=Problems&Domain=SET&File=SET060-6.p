...
<head>
<title>TPTP Problem File: SET060-6.p</title>
...
<body>
<HR><CENTER>
<H2>TPTP Problem File: SET060-6.p</H2><A HREF=SeeTPTP?Category=Solutions&Domain=SET&File=SET060-6 TARGET=_blank>
View Solutions</A>
- <A HREF="https://tptp.org/cgi-bin/SystemOnTPTP?TPTPProblem=SET060-6" TARGET="_blank">Solve Problem</A>
</CENTER><HR>
<pre>
%--------------------------------------------------------------------------
